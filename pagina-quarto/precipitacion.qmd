...
3.  Visualización: Precipitación Mensual

Análisis de la distribución de lluvias para la estación Las Ramadas (1970-2015).

```{r}
#| label: fig-boxplot
#| fig-cap: "Distribución de precipitación mensual en Las Ramadas (1970-2015)"
...
plot_boxplot <- function() {
  ...
  legend("topright", legend=c("Húmedo","Seco"), fill=c(paleta[100], paleta[1]), bty="n", cex=0.8)
}
